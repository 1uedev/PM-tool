  ...
  return (
    <div className="flex flex-col gap-5">
      <FieldGroup>
        ...
        <FieldTextarea fieldKey="problem" fields={fields} onChange={onChange} rich disabled={disabled}
      ...
      <FieldGroup>
        ...
        <FieldTextarea fieldKey="impact" fields={fields} onChange={onChange} rich disabled={disabled}
      ...
      <FieldGroup>
        ...
        <FieldTextarea fieldKey="currentSolution" fields={fields} onChange={onChange} rich disabled={disabled}
      ...
      <FieldGroup>
        ...
        <FieldTextarea fieldKey="whyInsufficient" fields={fields} onChange={onChange} rich disabled={disabled}
