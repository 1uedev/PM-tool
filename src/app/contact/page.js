...
const contactInfo = [
  { label: "Email", value: "hello@launchpad.dev", icon: "\u{1F4E7}" },
  { label: "Office", value: "San Francisco, CA", icon: "\u{1F4CD}" },
  { label: "Support", value: "support@launchpad.dev", icon: "\u{1F4AC}" },
];
